...
@HippoEssentialsGenerated(internalName = "scc:newsdocument")
@Node(jcrType="scc:newsdocument")
public class NewsDocument extends HippoDocument {

    /**
     * The document type of the news document.
     */
    public final static String DOCUMENT_TYPE = "scc:newsdocument";
    ...
    private final static String AUTHOR = "scc:author";
    private final static String SOURCE = "scc:source";
     ...
     * @return the author
     */
    @HippoEssentialsGenerated(internalName = "scc:author")
     ...
     * @return the source
     */
    @HippoEssentialsGenerated(internalName = "scc:source")
